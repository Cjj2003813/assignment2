...
public class LaboratoryController {
    ...
    // Added a new lab to manage the relationship between responsible teachers in the teacher list instead of recording the id of the supervisor in the lab list, which is more convenient. This strategy is not initially used in this method, but the logical judgment does not affect the use, so do not modify it.
    @Transactional
    ...
    public ModelAndView addLab(@RequestBody AddLabRequestParam addLabRequestParam)   {
        ...
        if(addLabRequestParam.getUsername()==null||addLabRequestParam.getUsername().equals("")){
            ...
            if(teachers.size()!=1){
                ...
                map.put(ConstVar._KEY_MESSAGE_, "Can't find a teacher with that job number");
